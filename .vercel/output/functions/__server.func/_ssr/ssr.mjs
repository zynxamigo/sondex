...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Yv1OTj3L.mjs");
...
var manifest = {
	"02ba5de5c12d0483beb3349dbee5cd1bbb16e61f9cc76c848a2def8cb7026697": {
		functionName: "deleteBot_createServerFn_handler",
		importer: () => import("./bots-CxdjjPdB.mjs")
	},
	"1f8b146da5a656a630dbdf8614c7e74e7b753228c4d6bcc639a25e40b4963819": {
		functionName: "renameFile_createServerFn_handler",
		importer: () => import("./bots-CxdjjPdB.mjs")
	},
	"3053c09a380f76a7e2fa32cdc321e2a27d863e9ad1426e8d576096ca4d18638b": {
		functionName: "createBot_createServerFn_handler",
		importer: () => import("./bots-CxdjjPdB.mjs")
	},
	"6d4aedb881bb8dad7c7c10cc3fd711b4b55d7c821f7a87f4c11f22fa3ae0ee96": {
		functionName: "renameBot_createServerFn_handler",
		importer: () => import("./bots-CxdjjPdB.mjs")
	},
	"6df1da0008df754925e3cc608f8a5ff58c3443b2a1db9f6d96c25c758cd0f7f6": {
		functionName: "scanWithGrok_createServerFn_handler",
		importer: () => import("./ai-scan-CCLlnl5a.mjs")
	},
	"763ed2a6163eeb7688eee629ca063eb69ad3b7dde991bcbe6475c63479d692ff": {
		functionName: "addFile_createServerFn_handler",
		importer: () => import("./bots-CxdjjPdB.mjs")
	},
	"91a3a98ca7d771911b1c964207f9ae7cdb5355d95f3388cbad1b7106e25e373b": {
		functionName: "dockBot_createServerFn_handler",
		importer: () => import("./bots-CxdjjPdB.mjs")
	},
	"a766492245316eceb04e369f25a9ed2413e8cabdd0af0b67f29fd6829b6af595": {
		functionName: "pulseBot_createServerFn_handler",
		importer: () => import("./bots-CxdjjPdB.mjs")
	},
	"b9badcf8de3ad6bf6316db2acfad23ef4e41fa31b7a66154129c21a00e3c9dea": {
		functionName: "sealCore_createServerFn_handler",
		importer: () => import("./bots-CxdjjPdB.mjs")
	},
	"c4353a76c1a14d83502e54484226cdce55d4aa7abc036396474bbe21d5f4e958": {
		functionName: "clearCore_createServerFn_handler",
		importer: () => import("./bots-CxdjjPdB.mjs")
	},
	"d3dfe8e9d29d6c429f1a5033d38baf53d254f0a2b019457b12fe2e44d098cf7a": {
		functionName: "getBot_createServerFn_handler",
		importer: () => import("./bots-CxdjjPdB.mjs")
	},
	"e0dd87e07a34684c1a93ab9cfdc72bb1327f5535f315c746b3fdd6bab82253ef": {
		functionName: "deleteFile_createServerFn_handler",
		importer: () => import("./bots-CxdjjPdB.mjs")
	},
	"e89e16667632b023fc49a4d893f86729ccb32bc9f16de3d881628b4f44502146": {
		functionName: "saveFiles_createServerFn_handler",
		importer: () => import("./bots-CxdjjPdB.mjs")
	},
	"f8add5235342a6bb970092bf2ae841d82d802916d6fafd55e23c70740a40aa82": {
		functionName: "launchBot_createServerFn_handler",
		importer: () => import("./bots-CxdjjPdB.mjs")
	},
	"fb575dd81437eaee2f9981630b78bffbcbff2ccafafd74b009acf50d16e9c957": {
		functionName: "listEvents_createServerFn_handler",
		importer: () => import("./bots-CxdjjPdB.mjs")
	},
	"fcd5f66709665ca47bdca5a35e4256975d3b5f99d9fbcd36537fcb4cc86f77ba": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CSQI5SkU.mjs").then((n) => n.t),
