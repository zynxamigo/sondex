...
}, { decorations: (v) => v.decorations }), baseTheme$1];
/**
...
//#endregion
export { tags as $, syntaxTree as A, EditorSelection as B, indentNodeProp as C, matchBrackets as D, languageDataProp as E, keymap as F, StateField as G, Facet as H, lineNumbers as I, combineConfig as J, Text as K, Annotation as L, EditorView as M, drawSelection as N, sublanguageProp as O, highlightActiveLine as P, styleTags as Q, ChangeDesc as R, getIndentation as S, indentUnit as T, Prec as U, EditorState as V, StateEffect as W, findClusterBreak as X, countColumn as Y, Tag as Z, flatIndent as _, HighlightStyle as a, NodeWeakMap as at, foldService as b, Language as c, parseMixed as ct, ParseContext as d, DefaultBufferLength as et, bracketMatching as f, delimitedIndent as g, defineLanguageFacet as h, snippetCompletion as i, NodeType as it, Direction as j, syntaxHighlighting as k, LanguageDescription as l, continuedIndent as m, completeFromList as n, NodeProp as nt, IndentContext as o, Parser as ot, bracketMatchingHandle as p, Transaction as q, ifNotIn as r, NodeSet as rt, LRLanguage as s, Tree as st, CompletionContext as t, IterMode as tt, LanguageSupport as u, foldInside as v, indentString as w, getIndentUnit as x, foldNodeProp as y, ChangeSet as z };
