...
import { n as auth } from "./server-B9GQXdVG.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CSQI5SkU.js
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 rounded-sm bg-bg-elevated px-2 py-1 text-xs text-fg shadow-[var(--shadow-border)]", className),
	...props
}) }));
TooltipContent.displayName = "TooltipContent";
var styles_default = "/assets/styles-DcmqRBDh.css";
var APP_NAME = "APOGEE";
var Route$6 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Apogee — foundry orbital para bots Discord. Escreva, sele o núcleo, lance e leia o pulso."
			},
			{
				name: "theme-color",
				content: "#09090b"
...
var $$splitComponentImporter$4 = () => import("./routes-DobzMlQe.mjs");
var Route$5 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./app-B6V8Fkq9.mjs");
var Route$4 = createFileRoute("/app")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./login-VjvZsG-c.mjs");
var Route$3 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./app.index-DklQryoJ.mjs");
var Route$2 = createFileRoute("/app/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./app._botId-CwAYkMb9.mjs");
var Route$1 = createFileRoute("/app/$botId")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
...
var AppBotIdRoute = Route$1.update({
	id: "/$botId",
	path: "/$botId",
	getParentRoute: () => AppRoute
});
...
//#endregion
export { Route$1 as n, cn as r, router_exports as t };
